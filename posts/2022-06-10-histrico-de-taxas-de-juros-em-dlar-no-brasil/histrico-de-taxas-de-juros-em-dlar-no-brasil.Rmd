...
[1]: ../2022-06-09-histrico-de-taxas-de-juros-de-longo-prazo/histrico-de-taxas-de-juros-de-longo-prazo.Rmd
...
```{r quandl-data-load, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
library(Quandl)
